...
{
    m_program = gl_create_program_from_resource("/org/SolveCad/SolveCad/canvas/shaders/face-vertex.glsl",
                                                "/org/SolveCad/SolveCad/canvas/shaders/face-fragment.glsl", nullptr);
    create_vao();
