...
void IconRenderer::realize()
{
    ...
    {
        auto atlas_pixbuf = Gdk::Pixbuf::create_from_resource("/org/SolveCad/SolveCad/canvas/icon_texture_atlas.png");
    ...
    m_program = gl_create_program_from_resource("/org/SolveCad/SolveCad/canvas/shaders/icon-vertex.glsl",
                                                "/org/SolveCad/SolveCad/canvas/shaders/icon-fragment.glsl",
                                                "/org/SolveCad/SolveCad/canvas/shaders/icon-geometry.glsl");
