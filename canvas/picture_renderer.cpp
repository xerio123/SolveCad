...
{
    m_program = gl_create_program_from_resource("/org/SolveCad/SolveCad/canvas/shaders/picture-vertex.glsl",
                                                "/org/SolveCad/SolveCad/canvas/shaders/picture-fragment.glsl", nullptr);
